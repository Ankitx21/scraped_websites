...
def entrepreneur_article_list(residential_proxies ,ca_cert_path,payload,headers):
...
if __name__ == "__main__":
    ...
    total_article_links = entrepreneur_article_list(residential_proxies ,ca_cert_path,payload,headers)
    articles_data = []
    ...
    with open("entrepreneur_articles.json", "w") as json_file:
