...
def fortune_article_list(residential_proxies ,ca_cert_path,payload,headers):
...
if __name__ == "__main__":
    ...
    total_article_links = fortune_article_list(residential_proxies ,ca_cert_path,payload,headers)
